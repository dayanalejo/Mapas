...
//Rare exceptions to indicate a bug in the _mapasprueba2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for MapasPrueba2 proxies.
 */
