...
/**
 The base class for all MapasPrueba2 modules
 */
...
/**
 MapasPrueba2 Platform calls this method on startup.
 */
-(void)startup;

/**
 MapasPrueba2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MapasPrueba2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MapasPrueba2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MapasPrueba2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
