...
@interface MapasPrueba2Object : KrollCoverageObject {
#else
@interface MapasPrueba2Object : KrollObject {
#endif
@private
...
extern NSString * MapasPrueba2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MapasPrueba2Object *_mapasprueba2;
    KrollObject* console;
	BOOL shutdown;
