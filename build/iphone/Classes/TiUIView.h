...
/**
 Base class for all MapasPrueba2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MapasPrueba2 view hierarchy (such as wrapped iOS UIViews) was touched.
