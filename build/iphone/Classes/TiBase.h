...
// in simulator we redefine to format for MapasPrueba2 Developer console
...
{\
	NSString * exceptionName = [@"org.mapasprueba2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mapasprueba2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMapasPrueba2NativeItemNone = -1, 
	UIMapasPrueba2NativeItemSpinner = -2,
	UIMapasPrueba2NativeItemProgressBar = -3,
	
	UIMapasPrueba2NativeItemSlider = -4,
	UIMapasPrueba2NativeItemSwitch = -5,
	UIMapasPrueba2NativeItemMultiButton = -6,
	UIMapasPrueba2NativeItemSegmented = -7,
	
	UIMapasPrueba2NativeItemTextView = -8,
	UIMapasPrueba2NativeItemTextField = -9,
	UIMapasPrueba2NativeItemSearchBar = -10,
	
	UIMapasPrueba2NativeItemPicker = -11,
	UIMapasPrueba2NativeItemDatePicker = -12,
	
	UIMapasPrueba2NativeItemInfoLight = -13,
	UIMapasPrueba2NativeItemInfoDark = -14,
	
	UIMapasPrueba2NativeItemDisclosure = -15,
	
	UIMapasPrueba2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MapasPrueba2 instances of
